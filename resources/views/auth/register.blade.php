                ...
                <div class="sign-in-from">
                    ...
                    <form class="mt-4" action="{{ route('register') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input name="name" type="text" class="form-control mb-0" id="exampleInputName" placeholder="Your Full Name">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input name="password_confirmation" type="password" class="form-control mb-0" id="exampleInputPassword2" placeholder="Password">
                        </div>
